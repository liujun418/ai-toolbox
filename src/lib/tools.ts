...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    howToUse: [
      ...
      "Choose a mode: Polish (fix grammar and flow), Rewrite (fresh wording), Shorten (cut fluff), Expand (add detail), Academic (formal tone), or Business (professional tone).",
      "Pick your output language — Auto Detect keeps the original language, or select from 10 languages to translate and process into a different language.",
      "Click the mode button and the AI will process your text.",
      "Copy, download, or try another text.",
    ],
    faq: [
      { question: "What languages does this tool support?", answer: "You can output in 10 languages: English, Spanish, Arabic, French, German, Chinese, Japanese, Korean, Portuguese, and Russian. Select 'Auto Detect' to keep the original language, or pick a specific output language to translate and process in one step." },
      { question: "What's the difference between Polish and Rewrite?", answer: "Polish fixes grammar, spelling, and sentence flow while preserving your original wording and tone. Rewrite expresses the same meaning with completely different wording and sentence structure — same message, fresh delivery." },
      { question: "How does the Shorten mode work?", answer: "Shorten removes redundancy and distills your text to the core message. It keeps all key facts and data points intact while cutting filler words and repetitive phrases." },
      { question: "Can Expand mode add meaningful content?", answer: "Yes. Expand adds relevant details, examples, and explanations to enrich your content without changing the original core message. Great for turning bullet points into paragraphs or beefing up thin sections." },
      { question: "Does the AI sound natural?", answer: "The prompts are designed to avoid AI clichés and formulaic phrasing. The output aims for natural, human-sounding writing regardless of the language you choose." },
    ],
