          ...
          <div className="space-y-6">
                ...
                <div className="flex aspect-square w-full items-center justify-center rounded-xl bg-zinc-100 dark:bg-zinc-800">
                  {status === "done" && resultUrl ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="mt-2 text-sm text-zinc-500">Transferring style...</p>
                    </div>
                  ) : status === "error" ? (
                    <p className="text-sm text-red-500">{errorMsg}</p>
                  ) : (
                    <p className="text-sm text-zinc-400">Select style and transform to see result</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="e.g., Make it look like a sunset painting with bold colors"
              />
            </div>
