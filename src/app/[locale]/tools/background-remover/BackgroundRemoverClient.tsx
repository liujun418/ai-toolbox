  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-zinc-900 dark:text-white">{t.title || "Background Remover"}</h1>
        <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
          {t.description || "Remove image backgrounds instantly with AI."}{" "}
          <span className="font-semibold text-blue-600">{t.cost || `${CREDIT_COST} credits`}</span>.
        </p>
      </div>
