...
for (const l of LOCALES) {
  ...
  const blogSlugs = ["how-to-remove-image-background-without-photoshop","best-ai-tools-content-creators-2026","restore-old-photos-ai-guide","ai-image-generator-prompt-guide","remove-watermark-from-photo","text-to-speech-for-content-creators","colorize-black-and-white-photos","ai-article-writing-vs-human","upscale-images-without-losing-quality","blur-faces-in-photos-privacy"];
